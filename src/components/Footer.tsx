        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              The trusted marketplace for buying and selling used electronic components, development boards, and engineering supplies.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/buyer-protection" className="text-gray-300 hover:text-white transition-colors">
                  Buyer Protection
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/dispute-resolution" className="text-gray-300 hover:text-white transition-colors">
                  Dispute Resolution
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">support@usedtech.com</span>
              </div>
              <div className="flex items-center space-x-3">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 UsedTech. All rights reserved.
            </p>
